...
export function QuizResults({ score, results }: QuizResultsProps) {
  ...
  return (
    <div className="animate-fade-in text-foreground">
      ...
      <Card className="mb-8 bg-secondary/80 border-primary/30">
      ...
      <div className="space-y-6">
        {results.opportunities.map((opp, index) => (
          <Card key={index} className="overflow-hidden border-l-4 border-primary bg-card/90 shadow-md">
            <CardHeader>
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                 <div className="bg-secondary/80 p-3 rounded-lg flex items-center gap-3">
      ...
      <div className="mt-10 text-center bg-card/90 p-8 rounded-xl border border-primary/30 shadow-xl">
